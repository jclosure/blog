...
<p>With this I get:</p>
<p><a href="/blog/assets/wp/loading-scripts-as-strings-into-the-dom-with-jquery/image.png"><img data-recalc-dims="1" loading="lazy" decoding="async" style="display:inline;border:0;" title="image" src="/blog/assets/wp/loading-scripts-as-strings-into-the-dom-with-jquery/image_thumb.png" border="0" alt="image" width="338" height="118" /></a></p>
